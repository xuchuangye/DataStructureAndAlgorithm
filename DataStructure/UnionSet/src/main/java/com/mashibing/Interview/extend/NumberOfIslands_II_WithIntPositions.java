...
import com.mashibing.unionset.UnionSetWithPositions;
 ...
 * @date 2022/5/3 - 10:24
 */
public class NumberOfIslands_II_WithIntPositions {
	...
	public static List<Integer> numIslands2(int m, int n, int[][] positions) {
		UnionSetWithPositions unionSetWithPositions = new UnionSetWithPositions(m, n);
		ArrayList<Integer> ans = new ArrayList<>();
		//positions = {{0,0}, {0,1}, {1,2}, {2,1}}
		for (int[] position : positions) {
			ans.add(unionSetWithPositions.connect(position[0], position[1]));
		}
		return ans;
	}
}
