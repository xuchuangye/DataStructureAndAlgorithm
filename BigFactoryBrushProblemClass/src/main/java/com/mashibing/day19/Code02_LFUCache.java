...
public class Code02_LFUCache {
	 ...
	 *
	 * @param removeNodeList removeNodeList：刚刚减少了一个节点的桶
	 * @return 函数的返回值表示刚刚减少了一个节点的桶是不是已经空了，空了返回true；不空返回false
	 */
	 ...
	 *
	 * @param node        node这个节点的次数 + 1了，这个节点原来在oldNodeList里。
	 * @param oldNodeList 把node从oldNodeList删掉，然后放到次数 +1的桶中
	 */
